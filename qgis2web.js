...
map.getView().fit([12549387.641208, -812306.569673, 12551555.364106, -809505.626830], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WEBGIS JANGKAUAN LAYANAN HALTE KECAMATAN GENTENG</h2>';
        return titleElement;
    })(),
